...
public class DateHelper {
    private static final long TIME_OFFSET = 2082844800L;
    /**
    ...
    static public Instant convertInstant(long secondsSince) {
        return Instant.ofEpochSecond(secondsSince - TIME_OFFSET);
    }
     ...
     * @return date in mac format
     */
    static public long convertInstant(Instant instant) {
        return instant.toEpochMilli() / 1000L + TIME_OFFSET;
    }
}
